...
from minicode.memory.context import SessionSummaryStore
from minicode.memory.episodic import EpisodicMemoryStore
from minicode.memory.graph import MemoryGraph, MemoryGraphStore
from minicode.memory.procedural import ProceduralMemoryStore
from minicode.memory.ranking import MemoryRankingPolicy
from minicode.memory.retrieval import HybridMemoryRetriever
from minicode.memory.semantic import SemanticMemoryStore
from minicode.memory.session import SessionMessageStore, SessionStore
...
def resolve_skill_candidate_dir(memory_dir: str, skill_candidate_dir: str) -> str:
    ...
    if (
        skill_candidate_dir == ".minicode/skill-candidates"
